...
FORM_FIELDS = {
    'doc01': {
        ...
        'fields': [
            ('Deceased name & NRIC', 'Step 2 — Deceased'),
            ('Deceased address', 'Step 2 — Deceased'),
            ('Date of death', 'Step 1 — Death Certificate'),
            ('Place of death', 'Step 1 — Death Certificate'),
            ('Applicant (Executor) name & NRIC', 'Step 2 — Executor'),
            ('Applicant address', 'Step 2 — Executor'),
            ('Court location', 'Step 3 — Court Info'),
            ('Case number', 'Step 3 — Court Info'),
            ('Firm name & address', 'Step 3 — Law Firm'),
            ('Firm reference', 'Step 3 — Law Firm'),
        ],
    },
    'doc02': {
        ...
        'fields': [
            ...
            ('Applicant name & NRIC', 'Step 2 — Executor'),
            ('Applicant relationship', 'Step 2 — Executor'),
    ...
    'doc03': {
        ...
        'fields': [
            ...
            ('Applicant name & NRIC', 'Step 2 — Executor'),
            ('Applicant address', 'Step 2 — Executor'),
            ('Court location & case number', 'Step 3 — Court Info'),
        ],
    },
    'doc04': {
        'name': 'Witness 1 Affidavit',
        'fields': [
            ('Witness 1 name & NRIC', 'Step 4 — Witnesses'),
            ('Witness 1 address', 'Step 4 — Witnesses'),
            ('Deceased name', 'Step 2 — Deceased'),
            ('Date of death', 'Step 1 — Death Certificate'),
            ('Court location & case number', 'Step 3 — Court Info'),
        ],
    },
    'doc05': {
        ...
        'fields': [
            ('Witness 2 name & NRIC', 'Step 4 — Witnesses'),
            ('Witness 2 address', 'Step 4 — Witnesses'),
            ('Deceased name', 'Step 2 — Deceased'),
            ('Date of death', 'Step 1 — Death Certificate'),
            ('Court location & case number', 'Step 3 — Court Info'),
        ],
    ...
    'doc06': {
        ...
        'fields': [
            ('Deceased name & NRIC', 'Step 2 — Deceased'),
            ('Properties (title, lot, mukim, address)', 'Step 6 — Assets'),
            ('Bank accounts (bank, account no., value)', 'Step 6 — Assets'),
            ('Vehicles (desc, reg no., engine, chassis)', 'Step 6 — Assets'),
            ('Other assets (description, value)', 'Step 6 — Assets'),
            ('Liabilities (description, value)', 'Step 6 — Assets'),
        ],
    },
    'doc07': {
        ...
        'fields': [
            ('Deceased name & NRIC', 'Step 2 — Deceased'),
            ('Beneficiary names & NRIC', 'Step 5 — Beneficiaries'),
            ('Beneficiary relationships', 'Step 5 — Beneficiaries'),
            ('Court location', 'Step 3 — Court Info'),
            ('Case number', 'Step 3 — Court Info'),
        ],
    },
    'doc08': {
        ...
        'fields': [
            ...
            ('Case number', 'Step 3 — Court Info'),
            ('Firm name & address', 'Step 3 — Law Firm'),
            ('Firm phone & fax', 'Step 3 — Law Firm'),
            ('Firm reference', 'Step 3 — Law Firm'),
        ],
    },
    'form14a': {
        ...
        'fields': [
            ('Property title number', 'Step 6 — Assets (Property)'),
            ('Property lot number', 'Step 6 — Assets (Property)'),
            ('Property mukim', 'Step 6 — Assets (Property)'),
            ('Deceased name & NRIC', 'Step 2 — Deceased'),
            ('Applicant name & NRIC', 'Step 2 — Executor'),
            ('Court location', 'Step 3 — Court Info'),
            ('Case number', 'Step 3 — Court Info'),
