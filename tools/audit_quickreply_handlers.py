...
KNOWN_HANDLERS = {
    ...
    'address:': '_try_save_testator_address (Step 2) | _try_handle_property_fill (Step 6)',
    'dob:': '_try_save_testator_address',
    'gender:': '_try_save_testator_address',
    'marital:': '_try_save_testator_address',
    'occupation:': '_try_save_testator_address',
